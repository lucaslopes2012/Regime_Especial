...
<Form method="POST" action="Add.php">
  ...
  <div class="row">
    ...
    <div class="form-group col-md-2">
      ...
      <input type="date" class="form-control" name="registro['Data_Nasc']" required>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="form-group col-md-2">
      ...
      <input type="text" class="form-control" name="registro['Celular']" required>
    </div>

    <div class="form-group col-md-6">
      <label for="campo4">Endereço</label>
      <input type="text" class="form-control" name="registro['Endereco']" required>
    </div>
  </div>
  ...
  <div class="row">
    <div class="form-group col-md-3">
      ...
      <input type="text" class="form-control" name="registro['Bairro']" required>
    </div>

    <div class="form-group col-md-3">
      <label for="campo3">Cidade:</label>
      <input type="text" class="form-control" name="registro['Cidade']" required>
    </div>
    
    <div class="form-group col-md-2">
      <label for="campo4">CEP:</label>
      <input type="text" class="form-control" name="registro['CEP']" required>
    </div>
